      ...
      <Modal
        ...
        <Box className="w-1/3 bg-white shadow-2xl transform-100 rounded-2xl border border-solid border-gray-300 p-4 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {/* Title */}
            <TextField required id="title" type="text" label="Title" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Ex. Gym"></TextField>


            {/* Cost */}
            <TextField required id="costAmount" type="number" label="Cost" value={costAmount} onChange={(e) => setCostAmount(e.target.value)} placeholder="Ex. 250"></TextField>
